/* 2020.12.15 - Original: https://github.com/hexenq/kuroshiro . Converted from CommonJS (NodeJS/NPM format, which Glitch can't handle) to ES6 format. */

exports.KATAKANA_HIRAGANA_SHIFT = "\u3041".charCodeAt(0) - "\u30a1".charCodeAt(0);
exports.HIRAGANA_KATAKANA_SHIFT = "\u30a1".charCodeAt(0) - "\u3041".charCodeAt(0);
 ...
 */
exports.isHiragana = function (ch) {
		ch = ch[0];
		return ch >= "\u3040" && ch <= "\u309f";
};
 ...
 */
exports.isKatakana = function (ch) {
		ch = ch[0];
		return ch >= "\u30a0" && ch <= "\u30ff";
};
 ...
 */
exports.isKana = function (ch) {
		return exports.isHiragana(ch) || exports.isKatakana(ch);
};
 ...
 */
exports.isJapanese = function (ch) {
		return exports.isKana(ch) || exports.isKanji(ch);
};
 ...
 */
exports.hasHiragana = function (str) {
		for (let i = 0; i < str.length; i++) {
				if (exports.isHiragana(str[i])) return true;
		}
		return false;
};
 ...
 */
exports.hasKatakana = function (str) {
		for (let i = 0; i < str.length; i++) {
				if (exports.isKatakana(str[i])) return true;
		}
		return false;
};
 ...
 */
exports.hasKana = function (str) {
		for (let i = 0; i < str.length; i++) {
				if (exports.isKana(str[i])) return true;
		}
		return false;
};
 ...
 */
exports.hasKanji = function (str) {
		for (let i = 0; i < str.length; i++) {
				if (exports.isKanji(str[i])) return true;
		}
		return false;
};
 ...
 */
exports.hasJapanese = function (str) {
		for (let i = 0; i < str.length; i++) {
				if (exports.isJapanese(str[i])) return true;
		}
		return false;
};
 ...
 */
exports.toRawHiragana = function (str) {
		return [...str].map((ch) => {
				if (ch > "\u30a0" && ch < "\u30f7") {
						return String.fromCharCode(ch.charCodeAt(0) + exports.KATAKANA_HIRAGANA_SHIFT);
				}
				return ch;
		}).join("");
};
 ...
 */
exports.toRawKatakana = function (str) {
		return [...str].map((ch) => {
				if (ch > "\u3040" && ch < "\u3097") {
						return String.fromCharCode(ch.charCodeAt(0) + exports.HIRAGANA_KATAKANA_SHIFT);
				}
				return ch;
		}).join("");
};
 ...
 */
exports.toRawRomaji = function (str, system) {
		system = system || exports.ROMANIZATION_SYSTEM.HEPBURN;
		...
		// [PASSPORT] 長音省略 「―」の場合
		if (system === exports.ROMANIZATION_SYSTEM.PASSPORT) {
				str = str.replace(/ー/gm, "");
		}

		// [NIPPON|HEPBURN] 撥音の特殊表記 a、i、u、e、o、y
		if (system === exports.ROMANIZATION_SYSTEM.NIPPON || system === exports.ROMANIZATION_SYSTEM.HEPBURN) {
		...
		if (system === exports.ROMANIZATION_SYSTEM.PASSPORT || system === exports.ROMANIZATION_SYSTEM.HEPBURN) {
		...
		// [NIPPON] 長音変換
		if (system === exports.ROMANIZATION_SYSTEM.NIPPON) {
		...
		// [HEPBURN] 長音変換
		if (system === exports.ROMANIZATION_SYSTEM.HEPBURN) {
 ...
 */
exports.getStrType = function (str) {
		let hasKJ = false;
		let hasHK = false;
		for (let i = 0; i < str.length; i++) {
				if (exports.isKanji(str[i])) {
						hasKJ = true;
				}
				else if (exports.isHiragana(str[i]) || exports.isKatakana(str[i])) {
						hasHK = true;
				}
		}
 ...
 */
exports.patchTokens = function (tokens) {
		// patch for token structure
		for (let cr = 0; cr < tokens.length; cr++) {
				if (exports.hasJapanese(tokens[cr].surface_form)) {
						if (!tokens[cr].reading) {
								if (tokens[cr].surface_form.split("").every(exports.isKana)) {
										tokens[cr].reading = exports.toRawKatakana(tokens[cr].surface_form);
								}
								else {
										tokens[cr].reading = tokens[cr].surface_form;
								}
						}
						else if (exports.hasHiragana(tokens[cr].reading)) {
								tokens[cr].reading = exports.toRawKatakana(tokens[cr].reading);
						}
				}
				else {
						tokens[cr].reading = tokens[cr].surface_form;
 ...
 * @return {string} Hiragana string
 */
exports.kanaToHiragna = function (str) {
		return exports.toRawHiragana(str);
};
 ...
 * @return {string} Katakana string
 */
exports.kanaToKatakana = function (str) {
		return exports.toRawKatakana(str);
};
 ...
 * @return {string} Romaji string
 */
exports.kanaToRomaji = function (str, system) {
		return exports.toRawRomaji(str, system);
};
